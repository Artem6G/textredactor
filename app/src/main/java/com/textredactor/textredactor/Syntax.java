...
class Syntax {
    ...
    Syntax(EditText editText) {
        if(!SettingsMemory.Syntax.equals("No syntax")) {
            ...
            if (SettingsMemory.Syntax.equals("CSS")) {
                setCssColor(editText, SettingsMemory.SyntaxColor);
            } else if (SettingsMemory.Syntax.equals("HTML")) {
...
replaceHmtl(editText, color);
    ...
    private void setCssColor(EditText editText, int color) {
        ...
        for (int i = 0; i < ind.size(); i++) {
            ...
            if(indEnd.size() >= i) {
                ...
                if (indEnd.get(i) > ind.get(i)) {
                    Spannable spans = new SpannableString(editText.getText().toString().substring(ind.get(i), indEnd.get(i) + 1));


                    for (int b = 1; b < spans.length() - 1; b++) {
                        check = spans.charAt(b) == '\n' || spans.charAt(b) == '/' || spans.charAt(b) == 'a' || spans.charAt(b) == 'b' || spans.charAt(b) == 'c' || spans.charAt(b) == 'd' ||
                                ...
                                spans.charAt(b) == 'K' || spans.charAt(b) == 'L' || spans.charAt(b) == 'M' || spans.charAt(b) == 'N' || spans.charAt(b) == 'O' || spans.charAt(b) == 'P' ||
                                spans.charAt(b) == 'Q' || spans.charAt(b) == 'R' || spans.charAt(b) == 'S' || spans.charAt(b) == 'T' || spans.charAt(b) == 'U' || spans.charAt(b) == 'V' ||
                                spans.charAt(b) == 'W' || spans.charAt(b) == 'X' || spans.charAt(b) == 'Y' || spans.charAt(b) == 'Z' ||  spans.charAt(b) == '#' ||spans.charAt(b) == '{' ||
                                spans.charAt(b) == '}' || spans.charAt(b) == '\'' || spans.charAt(b) == '!' || spans.charAt(b) == '/' || spans.charAt(b) == '*' || spans.charAt(b) == '\\' || spans.charAt(b) == ';';
                        if(!check) {
                            break;
                        }
                    }
                    ...
                    if(check)
                        editText.getText().replace(ind.get(i), indEnd.get(i) + 1, span(spans, color));
                }
             ...
             if (indEnd.get(i) > ind.get(i)) {
                 ...
                 for (int b = 1; b < spans.length() - 1; b++) {
                     check = spans.charAt(b) == '\n' || spans.charAt(b) == '/' || spans.charAt(b) == 'a' || spans.charAt(b) == 'b' || spans.charAt(b) == 'c' || spans.charAt(b) == 'd' ||
                             ...
                             spans.charAt(b) == 'K' || spans.charAt(b) == 'L' || spans.charAt(b) == 'M' || spans.charAt(b) == 'N' || spans.charAt(b) == 'O' || spans.charAt(b) == 'P' ||
                             spans.charAt(b) == 'Q' || spans.charAt(b) == 'R' || spans.charAt(b) == 'S' || spans.charAt(b) == 'T' || spans.charAt(b) == 'U' || spans.charAt(b) == 'V' ||
                             spans.charAt(b) == 'W' || spans.charAt(b) == 'X' || spans.charAt(b) == 'Y' || spans.charAt(b) == 'Z';
                     if(!check)
                         break;
